...
const BaseListComponent = forwardRef<EnhancedListRef<any>, BaseListProps<any>>(({
  ...
  emptyIcon = 'search' as MaterialIconName,
  emptyAction,
  error,
  onRetry,
    ...
    return (
      <View style={styles.emptyContainer}>
        ...
        {emptyAction && (
          ...
          >
            <Text style={[styles.emptyActionText, { color: '#FFFFFF' }]}>
              {emptyAction.title}
            </Text>
          </TouchableOpacity>
        )}
  ...
  // Combined header component - MUST be before conditional returns
    ...
    return (
      <View>
        {components.map((Component, index) => (
          <React.Fragment key={index}>{Component as React.ReactNode}</React.Fragment>
        ))}
      </View>
    );
  }, [renderSearchHeader, ListHeaderComponent]);

  // Combined footer component - MUST be before conditional returns
