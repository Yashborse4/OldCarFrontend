...
function OptimizedFlatList<T>({
  ...
  const getItemLayout = useMemo(
    () => itemHeight ? LIST_OPTIMIZATION.getItemLayout(itemHeight) : undefined,
    [itemHeight]
  );
  ...
  const refreshControl = useMemo(
    ...
    [onRefresh, refreshing, colors.primary, colors.surface]
  );
...
if (__DEV__) {
  (ItemSeparator as any).displayName = 'ItemSeparator';
  (FooterLoadingComponent as any).displayName = 'FooterLoadingComponent';
  (MemoizedOptimizedFlatList as any).displayName = 'OptimizedFlatList';
}
