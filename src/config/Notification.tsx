...
const NotificationItemComponent: React.FC<NotificationItemProps> = ({
  ...
  }, [notification.type, notification.variant, isDark]);
  ...
  const handleActionPress = useCallback(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [notification.action, notification.persistent, hideNotification]);

  if (!isVisible) return null;

  const notificationColors = getNotification();
  ...
  const getContainerStyles = (): ViewStyle => {
    ...
    switch (notification.variant) {
      case 'filled':
        return {
          ...baseStyle,
          backgroundColor: notificationColors.background || colors.surface,
        };
        ...
        {notification.action && (
          <TouchableOpacity
            ...
            style={[
              styles.actionButton,
              {
                backgroundColor: notification.action.style === ''
          ...
          >
            <Text
              style={[
                styles.actionText,
                {
                  color: notification.action.style === ''
