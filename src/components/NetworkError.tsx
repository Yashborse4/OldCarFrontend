...
export const NetworkError: React.FC<NetworkErrorProps> = ({
  ...
  const styles = StyleSheet.create({
    ...
    bannerContainer: {
      ...
      alignItems: 'center',
      borderBottomWidth: 1,
      borderBottomColor: isDark ? '#B71C1C' : '#FFCDD2',
    },
    bannerContent: {
      flex: 1,
      marginLeft: 12,
  ...
  return (
    <Modal visible={visible} transparent animationType="fade">
      <View style={styles.overlayContainer}>
        <Animatable.View animation="zoomIn" duration={500} style={styles.overlayContent}>
          <LinearGradient
            colors={[
              isDark ? 'rgba(211, 47, 47, 0.3)' : 'rgba(211, 47, 47, 0.1)',
              'transparent'
            ]}
