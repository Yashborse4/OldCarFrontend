    ...
    <View style={[styles.container, { backgroundColor: themeColors.background }]}>
      ...
      <Animated.View style={[styles.header, { opacity: headerOpacity }]}>
        ...
        <View style={styles.headerContent}>
          <TouchableOpacity onPress={() => navigation.goBack()} style={styles.backButton}>
            <MaterialIcons name="arrow-back" size={24} color={themeColors.white} />
          </TouchableOpacity>
          ...
          <Animated.View style={{ transform: [{ scale: favoriteScale }] }}>
            <TouchableOpacity onPress={handleFavoriteToggle} style={styles.favoriteButton}>
              <MaterialIcons 
                ...
                size={24} 
                color={isFavorite ? themeColors.error : themeColors.white} 
              />
            </TouchableOpacity>
          </Animated.View>
        </View>
            ...
            <View style={styles.sellerSection}>
              <Card variant="elevated" padding="none" style={styles.sellerCard}>
                <View style={styles.sellerAvatar}>
                  <MaterialIcons name="store" size={30} color={themeColors.white} />
                </View>
      ...
      >
        ...
        <Button
          ...
          variant="gradient"
          size="lg"
          icon={<MaterialIcons name="call" size={20} color={themeColors.white} />}
          iconPosition="left"
